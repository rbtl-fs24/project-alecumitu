...
To better understand the usage of single-use materials in biology labs, this project surveyed the Macromolecular Engineering Lab at ETH Zürich. The survey investigated how the weekly usage of single-use materials differs based on the type of experiment conducted. By analyzing the data collected, this research aims to provide valuable insights for optimizing waste management practices in biology labs and reducing the environmental footprint of laboratory activities, which is estimated to be about one-third of all indirect greenhouse gas emissions at ETH. (@greenlabs)

# Methods

Getting inspiration from @alves2021case, I decided to focus on lab tools that go on the route of the biohazard waste, since they are unsuitable for recycling.
